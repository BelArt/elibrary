<div class="fund-form">
    ...
    <form action="{{ route('case.save') }}" method="post" id="edit_case">
        ...
        <div class="fund-form-row">
            ...
            <input type="text" name="number" value="{{ $case->number }}" class="form-control" />
        </div>
        <div class="fund-form-row">
        ...
        <div class="fund-form-row">
            <label>Год</label>
            <input type="number" maxlength="4" minlength="4" name="year" value="{{ $case->year }}" class="form-control" />
        </div>
        <div class="fund-form-row">
